...
#  Diagnostic and Evaluation Helper Functions
#
...
#
#  Sourced by:
#    - Shiny_Dashboard_v2_0.R  (diagnostic helpers)
#    - model_fitting.R         (full MC pipeline)
#
#  Prerequisites (must be sourced before this file when used
#  outside the dashboard):
#    source("model_1_0.R")
#    source("data_simulation_1_0.R")  # required for run_one_replicate
# ============================================================
